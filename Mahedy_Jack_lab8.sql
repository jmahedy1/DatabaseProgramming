...
Assumption: A user wants to see the customer name, company, address, phone, and email
for new customers.
...
INSERT INTO CUSTOMER_NEW_VIEW(custname, address, city, state, postalcode)
    VALUES('John Doe', '401 N. Grant St.', 'West Lafayette', 'IN', '47906');

/* Qa3 Query Results

When I dont specify column names I get an error that says "not enough values".
When I specify column names I get an error that says "cannot insert null into the customerid"
which is the primary key. You can not do this becasue you are leaving out the primary key value.
*/
...
CREATE OR REPLACE VIEW CUSTOMER_ALL
AS
    SELECT customerid, custname, companyname, address, postalcode, city, state, phone, emailaddr
    FROM CUSTOMER_NEW
    UNION ALL
    SELECT customerid, custfirstname || ' ' || custlastname, companyname, address, postalcode, city, state, phone, emailaddr
    FROM customer;
...
Assumptions: A user want to see customer id, name, company, address, phone, email
for all new and old customers.
...
You can not insert into this view becasue it is created from two tables. Specifically 
the customer name in the customer table is two columns, first and last name. Customer name 
in the customer_new table is one column. Restrictions do not align so you can not insert.
*/
...
INSERT INTO INDIANA_CUSTOMER(custname, customerid, address, city, state, postalcode)
    VALUES('John Doe', 'C-001', '401 N. Grant St.', 'West Lafayette', 'IN', '47906');
...
I can insert this row becasue the view is created from one table, column names are 
specified, and the primary key is included.
...
I-301      Shannon Jing                                                                 Ms.   500 Oval Dr.                             West Lafayette       IN 47907                   765-588-7610 tarokingu@gmail.com                               
I-304      Kate Sun                                                                     Ms.   405 Sagamore Pkwy S.                     Lafayette            IN 47904                                katesun@gmail.com                                 
C-001      John Doe                                                                           401 N. Grant St.                         West Lafayette       IN 47906                                                                                  
...
The row was deleted from the indiana_customer view. The row was also deleted from 
the customer_new table. Originally when the row was inserted into the view it was
also inserted into the table. Then when we deleted the row from the view it was 
...
I first deleted all data from the table and checked that all the data was deleted. 
I then rolledback to the last commit which included the data in the table.
I checked that the data was in the table and the rollback was successful by querying 
the table again.
...
The Rollback after the truncate clause did not have the data. The rollback after the 
DELETE clause did have the data. The delete clause is DML, allows for deleting specified rows, 
and allows for rollbacks. The truncate clause is DDL, deletes all rows in the table, 
and does not allow for rollbacks.
...
REVOKE SELECT ON CUSTOMER_ALL FROM JMAHEDY;

/* Qa15 Query Results

I get an error. I cant grant or revoke privileges to/from yourself.
*/
...
https://docs.oracle.com/database/121/TTPLS/accesscntl.htm#TTPLS269

The privilage "execute" is needed for other users to use the procedure.
...
Once you drop the procedure the privilege will be removed forever. If the procedure
is created again the user will still not have access.

Procedure HELLO_WORLD dropped.

GRANTEE                                                                                                                          OWNER                                                                                                                            TABLE_NAME                                                                                                                       GRANTOR                                                                                                                          PRIVILEGE                                GRA HIE COM TYPE                     INH
-------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------- ---------------------------------------- --- --- --- ------------------------ ---
PUBLIC                                                                                                                           SYS                                                                                                                              JMAHEDY                                                                                                                          JMAHEDY                                                                                                                          INHERIT PRIVILEGES                       NO  NO  NO  USER                     NO 
...
The user will still have the privilege if you replace the function.

GRANTEE                                                                                                                          OWNER                                                                                                                            TABLE_NAME                                                                                                                       GRANTOR                                                                                                                          PRIVILEGE                                GRA HIE COM TYPE                     INH
-------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------- ---------------------------------------- --- --- --- ------------------------ ---
CNIT372TA                                                                                                                        JMAHEDY                                                                                                                          NUMBER_OF_EMPLOYEES                                                                                                              JMAHEDY                                                                                                                          EXECUTE                                  NO  NO  NO  FUNCTION                 NO 
PUBLIC                                                                                                                           SYS                                                                                                                              JMAHEDY                                                                                                                          JMAHEDY                                                                                                                          INHERIT PRIVILEGES                       NO  NO  NO  USER                     NO
*/
...
Recreating the procedure does not remove privileges. Dropping and creating does remove
privileges.
*/